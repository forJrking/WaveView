    ...
    public void idraw(Canvas canvas) {
        for (int i = 0, j = 0, k = 0; i < mTotalWidth; i++) {
            if (i + mXOneOffset < mTotalWidth) {
                canvas.drawLine(i, mTotalHeight - mYPositions[mXOneOffset + i] - 500, i, mTotalHeight, mWavePaint);
            } else {
                canvas.drawLine(i, mTotalHeight - mYPositions[j] - 500, i, mTotalHeight, mWavePaint);
                j++;
            }

            if (i + mXTwoOffset < mTotalWidth) {
                canvas.drawLine(i, mTotalHeight - mYPositions[mXTwoOffset + i] - 500, i, mTotalHeight, mWavePaint);
            } else {
                canvas.drawLine(i, mTotalHeight - mYPositions[k] - 500, i, mTotalHeight, mWavePaint);
                k++;
            }
        }
    }
